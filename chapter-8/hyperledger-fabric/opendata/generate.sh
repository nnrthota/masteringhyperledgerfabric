...
function generateChannelArtifacts() {
  ...
  configtxgen -profile financeGroupOrdererGenesis -outputBlock ./artifacts/genesis.block
  if [ "$?" -ne 0 ]; then
  ...
  echo
  echo "#################################################################"
  echo "### Generating channel configuration transaction 'financechannel.tx' ###"
  echo "#################################################################"
  configtxgen -profile opendataChannel -outputCreateChannelTx ./artifacts/financechannel.tx -channelID financechannel
  if [ "$?" -ne 0 ]; then
