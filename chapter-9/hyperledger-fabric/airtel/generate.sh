...
function generateChannelArtifacts() {
  ...
  configtxgen -profile netGroupOrdererGenesis -outputBlock ./artifacts/genesis.block
  if [ "$?" -ne 0 ]; then
  ...
  echo
  echo "#################################################################"
  echo "### Generating channel configuration transaction 'netchannel.tx' ###"
  echo "#################################################################"
  configtxgen -profile netGroupChannel -outputCreateChannelTx ./artifacts/netchannel.tx -channelID netchannel
  if [ "$?" -ne 0 ]; then
